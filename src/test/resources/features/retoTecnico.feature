@stories
  Feature: Fill out Utest form to create an user
    ...
    When he complete the form with his information
      ...
      | Carlos        | Perez       | xyzTest3@example.com.co     | December      | 2           | 1999         | Spanish         | Bogotá  | 111111         | Colombia   | Windows       | Windows 10 Pro     | Spanish            | Apple           | iPhone 13 mini | iOS 15.0.1  | _22Qur_dhP8L:zF | _22Qur_dhP8L:zF         |
